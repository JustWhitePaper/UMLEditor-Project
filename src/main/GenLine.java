...
public class GenLine extends BaseLine{
	protected Point start_port;
	protected Point end_port;
	public GenLine(int start, int end, int start_port, int end_port) {
	...
	protected void draw(Graphics g) {
		...
		g.drawLine(rotated_up.x, rotated_up.y, rotated_down.x, rotated_down.y);
	}
}
